# [Vault Hunters Official Pack (3rd Ed.)-3.20.1.0](https://www.curseforge.com/minecraft/modpacks/vault-hunters-1-18-2) on Curseforge
...
The docker on first run will download the same version as tagged of `Vault Hunters Official Pack (3rd Ed.)-3.20.1.0` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "Vault Hunters Official Pack (3rd Ed.)-3.20.1.0 Server Powered by Docker"
* LEVEL world
